...
|--------|-----------|-------------|---------------|---------------------|------------|-------------|
| mel | poktalabs | macOS 26.3 (darwin) | ~/workspaces/poktalabs | TM spec v1.0+v1.1, heavy-asset RESOURCES, shared-docs, open-source-projects-library | 2026-05-24 | 2026-05-28 |
