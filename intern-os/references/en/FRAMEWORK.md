...
| `REGISTRY.md` | Derived workstream index: active workstreams, thread bindings, health (generated, not hand-edited) |
...
`projects/REGISTRY.md` is a derived index of all active workstreams. It is generated by `generate-registry.sh` and must never be hand-edited.
...
| Output | Description |
|--------|-------------|
| `projects/REGISTRY.md` | Derived active workstream registry with thread bindings and health status |
